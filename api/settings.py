...
def init_settings():
    ...
    PARSERS = LLM.get(
        "parsers", "naive:General,bookstack:Bookstack,qa:Q&A,resume:Resume,manual:Manual,table:Table,paper:Paper,book:Book,laws:Laws,presentation:Presentation,picture:Picture,one:One,audio:Audio,email:Email,tag:Tag"
    )
