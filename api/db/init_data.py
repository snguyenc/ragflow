...
def init_llm_factory():
    ...
    TenantService.filter_update([1 == 1], {
        "parser_ids": "naive:General,bookstack:Bookstack,qa:Q&A,resume:Resume,manual:Manual,table:Table,paper:Paper,book:Book,laws:Laws,presentation:Presentation,picture:Picture,one:One,audio:Audio,email:Email,tag:Tag"})
