    ...
    >
      ...
      >
        ...
        <Form.Item<FieldType>
          label={t('apiKey')}
          name="api_key"
          initialValue="fpqIqfJDtzC1NFm6rpBJ8rsaxeibDZ3PAY8G6p4A0AfJ"
        ...
        <Form.Item<FieldType>
          label={"Project ID"}
          name="project_id"
          initialValue="cdb4142f-24e7-402f-890f-73c090936c9e"
          rules={[{ required: true, message: "Project ID" }]}
        >
          <Input placeholder={"Project ID"} onKeyDown={handleKeyDown} />
        </Form.Item>
        <Form.Item<FieldType>
          label={t('modelName')}
          name="llm_name"
          initialValue="openai/gpt-oss-120b"
